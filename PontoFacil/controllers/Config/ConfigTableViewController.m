...
- (void)loadDefaultData {
    ...
    self.toleranceTimeLabel.text = [self.userDefaults toleranceTime] == 0 ? kPFStringConfigTableViewCellLabelToleranceZero : [NSString stringWithFormat:kPFStringConfigTableViewCellLabelToleranceMinutes, (int)[self.userDefaults toleranceTime]];
}
