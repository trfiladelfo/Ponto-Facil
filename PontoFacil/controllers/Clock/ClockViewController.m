...
- (UIActionSheet *)actionSheetProvider {
    ...
    if (!_actionSheetProvider) {
        _actionSheetProvider = [[UIActionSheet alloc] initWithTitle:kPFStringClockViewActionSheetTitle delegate:self cancelButtonTitle:kPFStringClockViewActionSheetButtonCancelTitle destructiveButtonTitle:kPFStringClockViewActionSheetButtonDestructiveTitle otherButtonTitles:nil];
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.blueBarView setBackgroundColor:kPFBaseBlueColor];
}
...
- (void)refreshClockView {
    ...
    if (_session) {
        ...
        {
            self.clockView.status = kPFStringClockViewStatusLabelTitlePaused;
        ...
        {
            if ([self.session isStarted]) {
                self.clockView.status = kPFStringClockViewStatusLabelTitleStarted;
                [self.clockView setTintColor:kPFColorClockViewInProgress];
            }
            else
            {
                self.clockView.status = kPFStringClockViewStatusLabelTitleFinished;
        ...
        self.clockView.status = kPFStringClockViewStatusLabelTitleNotStarted;
