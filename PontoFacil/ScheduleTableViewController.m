...
- (NSArray *)sections {
    ...
    if (!_sections) {
        _sections = [NSArray arrayWithObjects:@"Trabalho", @"Intervalo", nil];
    }
...
- (NSArray *)staticRows {
    ...
    if (!_staticRows) {
        _staticRows = [NSArray arrayWithObjects:[NSArray arrayWithObjects:@"Entrada", @"Saída",nil], [NSArray arrayWithObjects:@"Início", @"Fim",nil], nil];
    }
